...
//        String connectDB = "jdbc:sqlserver://ssiot2014.sqlserver.rds.aliyuncs.com:3433;DatabaseName=iot2014";
    ...
    public void selete() {
        ...
        try {
            ...
            String sql2 = "select * from iot_User";
            String sql3 = "SELECT * FROM SYSOBJECTS WHERE XTYPE = 'U'";//查询所有表名
            String sql4 = "select * from Setting";
            String sql5 = "select * from information_schema.columns where table_name='iot_User'";//查看表结构 wrong
            String sql6 = "sp_help iot_User";
            String sql7 = "sp_helpdb";//列举数据库, 结果 iot2014 master msdb tempdb
            String sql8 = "select * from iot_User where Account=" + "'tscmy'" + "order by Account";
