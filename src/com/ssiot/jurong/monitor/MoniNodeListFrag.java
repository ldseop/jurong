...
//                    mNodeAdapter.notifyDataSetChanged();//不能notify，会无限循环
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView t = (TextView) headerView.findViewById(R.id.big_title);
        t.setText(JuRongActivity.AREATITLES[currentArea - 1]);
        headerView.setBackgroundResource(JuRongActivity.AREA_DRAWABLE_ID[currentArea - 1]);
