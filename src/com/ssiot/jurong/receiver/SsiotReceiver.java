package com.ssiot.jurong.receiver;
...
public class SsiotReceiver extends BroadcastReceiver{
    private static final String tag = "SsiotReceiver-jurong";
    public static final String ACTION_SSIOT_MSG = "com.ssiot.jurong.SHOWMSG";
    @Override
